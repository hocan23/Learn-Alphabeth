...
class QuizViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    func SetupConstraints (){
        ...
        leftButton.anchor(top: nil, bottom: view.safeAreaLayoutGuide.bottomAnchor, leading: nil, trailing: midButton.leadingAnchor, paddingTop: bottom1View.frame.height*0.1, paddingBottom: -100, paddingLeft:  0, paddingRight: -view.frame.width*0.05, width: view.frame.height*0.14, height: view.frame.height*0.13)
        midButton.anchor(top: nil, bottom: view.safeAreaLayoutGuide.bottomAnchor, leading: leftButton.trailingAnchor, trailing: nil, paddingTop: 0, paddingBottom: -100, paddingLeft:  view.frame.width*0.05, paddingRight: 0, width: view.frame.height*0.14, height: view.frame.height*0.12)
        rightButton.anchor(top: nil, bottom: view.safeAreaLayoutGuide.bottomAnchor, leading: midButton.trailingAnchor, trailing: nil, paddingTop: 0, paddingBottom: -100, paddingLeft:  view.frame.width*0.05, paddingRight: 0, width: view.frame.height*0.14, height: view.frame.height*0.12)
        }else{
